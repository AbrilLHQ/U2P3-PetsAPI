...
namespace U2P3_PetsAPI.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(PetsContext context)
        {
            _context = context;
        }
        ...
        {
            var petsContext = _context.Appointments.Include(a => a.Pet).Include(a => a.Vet);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["VetId"] = new SelectList(_context.Veterinarians, "VetId", "VetId");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,PetId,VetId,AppointmentDate,Reason")] Appointment appointment)
        {
